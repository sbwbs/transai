...
# Note: glossary_search moved to archive, using simplified version

class SearchResult:
    """Simplified SearchResult for compatibility"""
    def __init__(self, korean: str, english: str, source: str, match_type: str, score: float):
        self.korean = korean
...
class GlossarySearchEngine:
    """Placehosample_clientr for GlossarySearchEngine"""
